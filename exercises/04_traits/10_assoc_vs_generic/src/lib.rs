...
pub trait Power<P> {
    ...
    fn power(self, num: P) -> Self::Output;
}
...
impl Power<u64> for u32 {
    type Output = u32;

    fn power(self, num: u64) -> Self::Output {
        self + num as Self::Output
    }
}
